...
//		return new String[]{"classpath:testdata/common.xml","classpath:testdata/Stock.xml",
//		                    "classpath:testdata/Stock_"+testName.getMethodName()+".xml"};
		return null;
	}
	...
	public void findPage() {
		...
		StockQuery query = StockDataFactory.newStockQuery();
	...
	public void test_insert() {
		dao.insert(StockDataFactory.newStock());
	}
	
	@Test
	public void test_update() {
		dao.update(StockDataFactory.newStock());
	}
