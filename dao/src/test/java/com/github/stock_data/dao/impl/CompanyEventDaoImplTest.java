...
@Transactional
public class CompanyEventDaoImplTest {
	
	@Rule public TestName testName = new TestName();
	
	private CompanyEventDao dao;
...
//		return new String[]{"classpath:testdata/common.xml","classpath:testdata/CompanyEvent.xml",
//		                    "classpath:testdata/CompanyEvent_"+testName.getMethodName()+".xml"};
		return null;
	}
	...
	public void findPage() {
		...
		CompanyEventQuery query = CompanyEventDataFactory.newCompanyEventQuery();
	...
	public void test_insert() {
		dao.insert(CompanyEventDataFactory.newCompanyEvent());
	}
	
	@Test
	public void test_update() {
		dao.update(CompanyEventDataFactory.newCompanyEvent());
	}
