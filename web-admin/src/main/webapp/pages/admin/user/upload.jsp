...
<rapid:override name="content">
	<h2 id="title" class="text-center">导入User</h2>
	
	<form id="inputForm" class="form-horizontal" action="${ctx}/admin/user/upload.do" method="post"  enctype="multipart/form-data" >
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				...
				<span class="help-block"><a href="${ctx}/pages/admin/user/upload_User.csv" >下载数据上传模板</a></span>
			</div>
		</div>
