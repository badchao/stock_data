...
<rapid:override name="content">
	<h2 id="title" class="text-center">创建User</h2>
	
	<form:form id="inputForm" method="post" cssClass="form-horizontal" action="${ctx}/admin/user/create.do" modelAttribute="user" >
