...
<rapid:override name="head">
	<title>CompanyEvent编辑</title>
</rapid:override>

<rapid:override name="content">
	<h2 id="title" class="text-center">编辑CompanyEvent</h2>
	
	<form:form id="inputForm" method="post" cssClass="form-horizontal" action="${ctx}/admin/companyevent/update.do" modelAttribute="companyEvent">
