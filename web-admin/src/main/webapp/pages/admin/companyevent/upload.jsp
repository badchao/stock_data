...
<rapid:override name="head">
	<title>导入CompanyEvent</title>
</rapid:override>

<rapid:override name="content">
	<h2 id="title" class="text-center">导入CompanyEvent</h2>
	
	<form id="inputForm" class="form-horizontal" action="${ctx}/admin/companyevent/upload.do" method="post"  enctype="multipart/form-data" >
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				...
				<span class="help-block"><a href="${ctx}/pages/admin/companyevent/upload_CompanyEvent.csv" >下载数据上传模板</a></span>
			</div>
		</div>
