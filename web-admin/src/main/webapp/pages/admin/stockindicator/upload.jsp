...
<rapid:override name="head">
	<title>导入StockIndicator</title>
</rapid:override>

<rapid:override name="content">
	<h2 id="title" class="text-center">导入StockIndicator</h2>
	
	<form id="inputForm" class="form-horizontal" action="${ctx}/admin/stockindicator/upload.do" method="post"  enctype="multipart/form-data" >
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				...
				<span class="help-block"><a href="${ctx}/pages/admin/stockindicator/upload_StockIndicator.csv" >下载数据上传模板</a></span>
			</div>
		</div>
