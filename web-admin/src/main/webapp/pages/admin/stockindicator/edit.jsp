...
<rapid:override name="head">
	<title>StockIndicator编辑</title>
</rapid:override>

<rapid:override name="content">
	<h2 id="title" class="text-center">编辑StockIndicator</h2>
	
	<form:form id="inputForm" method="post" cssClass="form-horizontal" action="${ctx}/admin/stockindicator/update.do" modelAttribute="stockIndicator">
