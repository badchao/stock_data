...
<rapid:override name="head">
	<title>创建StockIndicator</title>
</rapid:override>

<rapid:override name="content">
	<h2 id="title" class="text-center">创建StockIndicator</h2>
	
	<form:form id="inputForm" method="post" cssClass="form-horizontal" action="${ctx}/admin/stockindicator/create.do" modelAttribute="stockIndicator" >
