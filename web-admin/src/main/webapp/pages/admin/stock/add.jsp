...
<rapid:override name="content">
	<h2 id="title" class="text-center">创建Stock</h2>
	
	<form:form id="inputForm" method="post" cssClass="form-horizontal" action="${ctx}/admin/stock/create.do" modelAttribute="stock" >
