...
<rapid:override name="head">
	<title>DwStock编辑</title>
</rapid:override>

<rapid:override name="content">
	<h2 id="title" class="text-center">编辑DwStock</h2>
	
	<form:form id="inputForm" method="post" cssClass="form-horizontal" action="${ctx}/admin/dwstock/update.do" modelAttribute="dwStock">
